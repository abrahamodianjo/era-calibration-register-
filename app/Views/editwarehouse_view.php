...
<nav class="navbar navbar-dark bg-danger ">
  ...
  <h3 class="text-danger fw-bold text-center mb-5">Edit Warehouse Equipment</h3>
    <form method="post" id="update_warehouse" name="update_warehouse" action="<?= site_url('/updatewarehouse') ?>">
      <input type="hidden" name="id" id="id" value="<?php echo $warehouse_obj['id']; ?>">
      <div class="form-group">
        <label>ERA No</label>
        <input type="text" name="era_no" class="form-control" value="<?php echo $warehouse_obj['era_no']; ?>">
      </div>
      <div class="form-group">
        <label>Tool Type</label>
        <input type="text" name="tool_type" class="form-control" value="<?php echo $warehouse_obj['tool_type']; ?>">
      </div>
      <div class="form-group">
        <label>Manufacturer Name</label>
        <input type="text" name="manufacturer_name" class="form-control" value="<?php echo $warehouse_obj['manufacturer_name']; ?>">
      </div>
      <div class="form-group">
        <label>Frequency</label>
        
        <select name="frequency" value="<?php echo $warehouse_obj['frequency']; ?>">
      ...
      <div class="form-group">
        ...
        <input type="date" name="due_date" class="form-control" value="<?php echo $warehouse_obj['due_date']; ?>">
      </div>
      <div class="form-group">
  ...
  <script>
    if ($("#update_warehouse").length > 0) {
      $("#update_warehouse").validate({
        rules: {
          frequency: {
            required: true,
          }
