...
<nav class="navbar navbar-dark bg-danger ">
    ...
    <div class="offcanvas offcanvas-end text-bg-danger" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="<?php echo site_url('/hse-list') ?>">Health & Safety Team</a>
          </li>
          <li class="nav-item">
  ...
  <h3 class="text-danger fw-bold text-center mb-5">Edit Engineering Equipment</h3>
    <form method="post" id="update_hse" name="update_hse" action="<?= site_url('/updatehse') ?>">
      <input type="hidden" name="id" id="id" value="<?php echo $hse_obj['id']; ?>">
      <div class="form-group">
        <label>ERA No</label>
        <input type="text" name="era_no" class="form-control" value="<?php echo $hse_obj['era_no']; ?>">
      </div>
      <div class="form-group">
        <label>Tool Type</label>
        <input type="text" name="tool_type" class="form-control" value="<?php echo $hse_obj['tool_type']; ?>">
      </div>
      <div class="form-group">
        <label>Manufacturer Name</label>
        <input type="text" name="manufacturer_name" class="form-control" value="<?php echo $hse_obj['manufacturer_name']; ?>">
      </div>
      <div class="form-group">
        <label>Frequency</label>
        
        <select name="frequency" value="<?php echo $hse_obj['frequency']; ?>">
      ...
      <div class="form-group">
        ...
        <input type="date" name="due_date" class="form-control" value="<?php echo $hse_obj['due_date']; ?>">
      </div>
      <div class="form-group">
