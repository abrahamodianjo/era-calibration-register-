...
<div class="container mt-5 text-center">
  <h2 class="text-danger fw-bold"> Health & Safety Team Records</h2>
</div>
...
<div class="container mt-4">
   ...
   <a href="<?php echo site_url('/hse-form') ?>" class="btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
     ...
     <table class="table  table-striped table-columns container table-hover" id="users-list">
       ...
       <tbody>
          ...
          <tr>
             ...
             <td>
                    <a href="<?php echo base_url('edithse-view/'.$user['id']);?>" class="btn btn-danger btn-sm">
                ...
                <td>
                  <a href="<?php echo base_url('deletehse/'.$user['id']);?>" class="btn btn-dark btn-sm">
