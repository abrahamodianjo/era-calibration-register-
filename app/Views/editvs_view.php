...
<nav class="navbar navbar-dark bg-danger ">
  ...
  <h3 class="text-danger fw-bold text-center mb-5">Edit Vertical Sliding Equipment</h3>
    <form method="post" id="update_vs" name="update_vs" action="<?= site_url('/updatevs') ?>">
      <input type="hidden" name="id" id="id" value="<?php echo $vs_obj['id']; ?>">
      <div class="form-group">
        <label>ERA No</label>
        <input type="text" name="era_no" class="form-control" value="<?php echo $vs_obj['era_no']; ?>">
      </div>
      <div class="form-group">
        <label>Tool Type</label>
        <input type="text" name="tool_type" class="form-control" value="<?php echo $vs_obj['tool_type']; ?>">
      </div>
      <div class="form-group">
        <label>Manufacturer Name</label>
        <input type="text" name="manufacturer_name" class="form-control" value="<?php echo $vs_obj['manufacturer_name']; ?>">
      </div>
      <div class="form-group">
        <label>Frequency</label>
        
        <select name="frequency" value="<?php echo $vs_obj['frequency']; ?>">
      ...
      <div class="form-group">
        ...
        <input type="date" name="due_date" class="form-control" value="<?php echo $vs_obj['due_date']; ?>">
      </div>
      <div class="form-group">
