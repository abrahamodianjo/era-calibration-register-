...
<nav class="navbar navbar-dark bg-danger ">
  ...
  <div class="container mt-5 mb-5">
    <h3 class="text-danger fw-bold text-center mb-5">Add New Engineering Equipment</h3>
    <form method="post" id="add_create" name="add_create" action="<?= site_url('/submit-form-engineering') ?>">
