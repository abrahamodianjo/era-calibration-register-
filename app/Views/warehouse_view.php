    ...
    <div class="offcanvas offcanvas-end text-bg-danger" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li class="nav-item">
            <a class="nav-link "aria-current="page" href="<?php echo site_url('/vs-list') ?>">Vertical Sliding</a>
          </li>
          <li class="nav-item">
...
<div class="container mt-5 text-center">
  <h2 class="text-danger fw-bold"> Warehouse Team Records</h2>
</div>
...
<div class="container mt-4">
   ...
   <a href="<?php echo site_url('/warehouse-form') ?>" class="btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
     ...
     <table class="table  table-striped table-columns container table-hover" id="users-list">
       ...
       <tbody>
          ...
          <tr>
             ...
             <td>
                    <a href="<?php echo base_url('editwarehouse-view/'.$user['id']);?>" class="btn btn-danger btn-sm">
                ...
                <td>
                  <a href="<?php echo base_url('deletewarehouse/'.$user['id']);?>" class="btn btn-dark btn-sm">
